...
from ops.metric import compute_scene_flow_metrics
...
def solver(
    ...
    for epoch in range(args.iters):
        ...
        EPE3D_1, acc3d_strict_1, acc3d_relax_1, outlier_1, angle_error_1 = compute_scene_flow_metrics(flow_pred_1_final,
                                                                                                      flow_metrics)
